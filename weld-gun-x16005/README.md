...
**外形改善版 (r4 候補)** を [authoring/README.md](authoring/README.md) に追加した。
公表外形 1161 × 532 × 302 mm、型番付き写真に基づく部品配置、部位別 PBR 材質を持つ
[新しい USD](usd/weld-gun-x16005.usda)。生成は Node.js + three-usd-robot。
下記は旧 r3 の記録であり、既存の URDF / STL は再現用に変更していない。
